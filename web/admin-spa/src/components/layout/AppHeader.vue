    ...
    <div class="flex flex-col items-center justify-between gap-3 sm:flex-row sm:gap-4">
      ...
      <div class="flex items-center gap-2 sm:gap-4">
        ...
        <div class="user-menu-container relative">
          <button
            class="user-menu-button flex items-center gap-2 rounded-2xl border border-gray-300 bg-white px-3 py-2 text-sm font-semibold text-gray-700 shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-xl active:scale-95 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200 sm:px-4 sm:py-2.5"
            @click="userMenuOpen = !userMenuOpen"
          >
            <i class="fas fa-user-circle text-sm text-blue-500 dark:text-blue-400 sm:text-base" />
